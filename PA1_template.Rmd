...
```{r, echo = TRUE}
setwd("C:/Users/HB_LT_45F/Desktop/RESEARCH")
library(ggplot2)
...
```
#The 5-minute interval, on average across all the days in the dataset, contains the maximum number of steps is  `r StepsInterval[which.max(StepsInterval$steps), 
